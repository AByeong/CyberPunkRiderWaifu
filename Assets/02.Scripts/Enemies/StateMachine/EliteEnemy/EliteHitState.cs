...
public class EliteHitState : EliteBaseState
{
    ...
    public override void OnEnter()
    {
        ...
        {
            _knockbackDir = (Owner.transform.position - Owner.TakedDamage.From.transform.position).normalized;
            _knockbackDir.y = 0;
        }
        else
        {
            _knockbackDir = (Owner.transform.position - Owner.Target.transform.position).normalized;
            _knockbackDir.y = 0;
        }
